...
export function formatEmoji(emoji: Emoji | string): string | null {
    ...
    if (typeof emoji === "string") {
        ...
        if (match) {
            ...
            const id = match[2];
            return `https://cdn.discordapp.com/emojis/${id}.${isAnimated ? 'gif' : 'png'}?size=4096&quality=lossless`;
        }
        return `https://cdn.jsdelivr.net/gh/jdecked/twemoji@latest/assets/svg/${emojiUnicode(emoji)}.svg`;
    }
